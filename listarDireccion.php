                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                $sql = mysqli_query($con, "SELECT * FROM direccion");
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td><?php echo $result['idDireccion']; ?></td>
                                        ...
                                        <?php
                                        $idDir = $result['idDireccion'];
                                        $sql2 = mysqli_query($con, "SELECT email from usuario U inner join direccion D on U.email = D.usuario_email where idDireccion = '$idDir'");
                                        $resul = mysqli_fetch_array($sql2)
                                        ?>
